...
def run_test(points, inlier_ratio, switching_threshold, min_cluster_size):
    """
...
def objective_function(params, points):
    ...
    # run the test
    iou, chamfer = run_test(points, inlier_ratio, switching_threshold, min_cluster_size)
...
def optimize_superquadrics(points):
    ...
    final_iou, final_chamfer = run_test(points, best_params[0], best_params[1], best_params[2])
